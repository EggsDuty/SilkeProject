...
function Header() {
    ...
    return (
        ...
        <div className="bg-darkBlue flex flex-row min-h-10 bg-opacity-70">
            ...
            <Link to='/home' reloadDocument={true} className="text-white ml-32 leading-9 px-10 border-x-2 transition-all duration-1000 hover:bg-gradient-to-t hover:from-gray-400 hover:to-50% hover:to-transparent">Home</Link>
