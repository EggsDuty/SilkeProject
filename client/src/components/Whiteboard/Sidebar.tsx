...
function Sidebar(){
    ...
    return(
        <div className="flex flex-col h-[calc(100vh-2.5rem)] w-32 bg-[#100524] sticky left-0 z-50 text-white text-center pt-32 space-y-4 overflow-visible">
            ...
            <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40 " onClick={() => addCalculator(<div><p className="text-black">Standard calculator</p><StandardCalculator /></div>)}>Standard Calculator</div>
            <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40" onClick={() => addCalculator(<div><p className="text-black">Scientific calculator</p><ScientificCalculator /></div>)}>Scientific Calculator</div>
            <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40" onClick={() => addCalculator(<div><p className="text-black">Graphing calculator</p><GraphingCalculators /></div>)}>Graphing Calculator</div>
