...
function Sidebar(){
    ...
    return(
        <div className="flex flex-col h-[calc(100vh-2.5rem)] w-32 bg-[#100524] sticky left-0 z-50 text-white text-center pt-32 space-y-4 overflow-visible">
            ...
            <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40 " onClick={() => addCalculator(<StandardCalculator />)}>Standard Calculator</div>
            <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40" onClick={() => addCalculator(<ScientificCalculator />)}>Scientific Calculator</div>
            <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40" onClick={() => addCalculator(<GraphingCalculators />)}>Graphing Calculator</div>
