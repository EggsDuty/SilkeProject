...
function Sidebar() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-2.5rem)] w-32 bg-[#100524] sticky left-0 z-50 text-white text-center pt-32 space-y-4 overflow-visible">
      ...
      <div className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40" onClick={() => addCalculator(<div style={{ width: '100%', height: '100%', overflow: 'auto' }}><p className="text-black">Graphing calculator</p><GraphingCalculators /></div>, { width: 1120, height: 500 })}>Graphing Calculator</div>
