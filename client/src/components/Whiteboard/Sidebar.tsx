...
function Sidebar() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-2.5rem)] w-32 bg-[#100524] sticky left-0 z-50 text-white text-center pt-32 space-y-4 overflow-visible">
      ...
      <div
        className="border-2 mx-3 rounded-lg hover:cursor-pointer py-1 bg-secondaryColor bg-opacity-40"
        role="none"
        onClick={() =>
          addCalculator(
            <div style={{ width: "100%", height: "100%", overflow: "auto" }}>
              <p className="text-black h-[24px]">Standard calculator</p>
              <div className="w-[100%] h-[100%]" style={{ height: "calc(100% - 24px" }}>
                <StandardCalculator />
              </div>
            </div>,
            { width: 341, height: 540 }
          )
        }
      >
        Standard Calculator
      ...
      <div
        ...
        onClick={() =>
          addCalculator(
            <div style={{ width: "100%", height: "100%", overflow: "auto" }}>
              <p className="text-black h-[24px]">Scientific calculator</p>
              <div className="w-[100%] h-[100%]" style={{ height: "calc(100% - 24px" }}>
      ...
      <div
        ...
        onClick={() =>
          addCalculator(
            <div style={{ width: "100%", height: "100%", overflow: "auto" }}>
              <p className="text-black h-[24px]">Graphing calculator</p>
              <div className="w-[100%] h-[100%]" style={{ height: "calc(100% - 24px" }}>
                <GraphingCalculators />
              </div>
            </div>,
            { width: 918, height: 356.5 }
          )
        }
      >
        Graphing Calculator
      ...
      <div
        ...
        onClick={() =>
          addCalculator(
            <div style={{ width: "100%", height: "100%", overflow: "auto" }} className="justify-center items-center">
              <p className="text-black h-[24px] justify-center items-center">Programmers calculator</p>
              <div className="w-[100%] h-[100%]" style={{ height: "calc(100% - 24px" }}>
                <ProgrammersCalculator />
              </div>
            </div>,
            { width: 315.6, height: 424 }
          )
        }
      >
      ...
      {calculators.map((id) => (
        <DraggableBox key={id} initialSize={calculatorPositions[id].initialSize}>
          <button className="text-xs text-gray-500 hover:text-gray-300 bg-primaryColor h-[22px]" onClick={() => removeCalculator(id)}>
            Remove
          </button>
          <div className="relative w-[100%] " style={{ height: "calc(100% - 22px)" }}>
            {calculatorPositions[id].calculator}
          </div>
        </DraggableBox>
      ))}
    </div>
