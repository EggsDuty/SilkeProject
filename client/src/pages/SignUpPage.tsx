...
function LoginPage() {
    ...
    return (
        <div className="bg-test h-screen w-screen absolute bg-cover">
            <form onSubmit={(e) => handleSignUp(e)} className="bg-indigo-800 w-1/3 m-auto mt-32 py-5 px-10 rounded-lg">
                <Link to="/" reloadDocument={true} className="-ml-5 text-xl text-white hover:text-indigo-200">&larr; Back</Link>
