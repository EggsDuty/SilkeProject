...
function GraphingCalculators() {
  ...
  interface Equation {
    Input1: string;
    type: "linear" | "implicit" | "polar" | "parametric" | "vector" | "text";
    color?: string;
    closed?: boolean;
    Input2?: string;
    Input3?: string;
  ...
  const [equations, setEquations] = useState<Equation[]>([
    { Input1: "log(3*x) / log(6)", type: "linear" },
    { Input1: "2*x", type: "linear" },
    { Input1: "x^2", type: "linear" },
    { Input1: "2^x", type: "linear" },
    { Input1: "exp(x)", type: "linear" },
    { Input1: "sqrt(x)", type: "linear" },
    { Input1: "nthRoot(x,3)", type: "linear" },
    { Input1: "x*x+y*y-1", type: "implicit" },
  ]);
  //Graph
  ...
  const addEquation = () => {
    setEquations([...equations, { Input1: "", type: "linear" }]);
  };
    ...
    <div className=" absolute w-full h-full ">
      ...
      <div className="flex h-full">
        <div className="w-2/5">
            ...
            children={
              <div className="bg-slate-500 rounded border-8 border-black w-4/6 m-auto overflow-y-scroll h-96 bg-opacity-95">
                ...
                <p className="m-1">
                  ...
                  your input and [x, y] coordinates(does not work for implicit
                  functions).<br></br>
                ...
                <h1 className="text-lg m-1 md:font-semibold italic">
                  ...
                  functions), otherwise the graph will be unresponsive until you
                  correct it
                </h1>
                <h1 className="text-3xl text-center m-3 md:font-bold">
                  OPERATORS
          ...
          {equations.map(
            (
              {  Input1, type, Input2, Input3, Input4 },
              index
            ) => (
