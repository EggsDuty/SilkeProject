...
function LandingPage() {
    return (
        <div className="bg-test h-screen w-screen absolute bg-cover">
            ...
            <div className="flex flex-row space-x-10 mt-32 ml-52 text-white">
                <Link to='/signup' reloadDocument={true} className="py-2 px-8 rounded-lg bg-indigo-900 border-2 border-opacity-0 hover:border-opacity-100 border-white">Sign up</Link>
                <Link to='/login' reloadDocument={true} className="py-2 px-6 rounded-lg bg-indigo-500 border-2 border-opacity-0 hover:border-opacity-100 border-white">Log in</Link>
